      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-[#222] p-6 rounded-lg shadow-md border border-gray-700">
              <div className="flex items-center mb-4">
                <LucideUser className="h-6 w-6 text-[#f0b100] mr-2" />
                  ...
                  {visit.visitor.phone_number && (
                    <div className="flex items-center">
                      ...
                      <a 
                        ...
                        className="ml-auto text-[#f0b100] hover:text-[#e0a000]"
                      >
          ...
          <div className="lg:col-span-2">
            <div className="bg-[#222] rounded-lg shadow-md border border-gray-700">
              <div className="border-b border-gray-700 p-6">
                <div className="flex items-center mb-4">
                  <LucideCalendar className="h-6 w-6 text-[#f0b100] mr-2" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-white">
                  <div>
                    ...
                    <p className="bg-[#333] p-2 rounded mt-1">{visit.reason}</p>
                  </div>
                  ...
                  <div className="flex items-center">
                    <LucideClock className="h-4 w-4 text-[#f0b100] mr-2" />
                    <div>
              ...
              <div className="border-b border-gray-700 p-6">
                <div className="flex items-center mb-4">
                  <LucideShield className="h-6 w-6 text-[#f0b100] mr-2" />
                ...
                <div className="p-6">
                  ...
                  <div className="divide-y divide-gray-700">
                    {visit.incidents.map((incident: any) => (
                      <div key={incident.id} className="py-4 first:pt-0 last:pb-0 text-white">
                        ...
                        <p className="bg-[#333] p-3 rounded">{incident.description}</p>
